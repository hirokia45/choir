...
const Piece: FC<{ pageData: ProjectDocument }> = ({ pageData }) => {
  return (
    <>
      <Head>
...
export const getStaticProps = async (props: GetStaticPropsContext) => {
  ...
  const page = await client.getByUID("song", props.params!.uid as string);
...
export const getStaticPaths = async ({}) => {
  ...
  const pages = await client.getAllByType("song");
